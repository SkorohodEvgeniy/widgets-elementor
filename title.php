...
class Templines_Custom_Title extends Widget_Base {

    public function get_name() {
        return 'templines-custom-title';
    }

    public function get_title() {
        return esc_html__( 'Custom Title', 'templines-helper-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .sub-title' => 'font-size: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .sub-title' => 'line-height: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .sub-title' => 'letter-spacing: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        $this->add_control(
